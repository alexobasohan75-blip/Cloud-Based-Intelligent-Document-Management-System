...
urlpatterns = [
    ...
    path(
        "document/<str:document_id>/download/",
        doc_views.download_document,
    ...
    path(
        "admin-panel/",
        doc_views.admin_panel,
        name="admin_panel",
    ),

    path(
        "admin-panel/categories/",
        doc_views.manage_categories,
        name="manage_categories",
    ),

    path(
        "admin-panel/users/",
        doc_views.manage_users,
        name="manage_users",
    ),

    path(
        "admin-panel/logs/",
        doc_views.audit_log_view,
        name="audit_logs",
    ),

    path(
        "reports/",
        doc_views.reports_view,
        name="reports",
    ),
]
